...
ThreadPool::ThreadPool(detail::IThread::Factory factory, QObject *parent) :
    IThreadPool(parent), shutDown_(false), paused_(false),
...
WorkItemPtr ThreadPool::attach(std::function<void(unsigned)> function, unsigned int priority)
{
